...
class WrappedPointNavResNetPolicy:
    ...
    def __init__(
        ...
        self.policy = load_pointnav_policy(ckpt_path, original_config=original_config)
...
def load_pointnav_policy(file_path: str, original_config=None) -> PointNavResNetTensorOutputPolicy:
    ...
    if HABITAT_BASELINES_AVAILABLE:
        ...
        if habitat_version == "0.1.5":
            ...
            pointnav_policy = PointNavResNetTensorOutputPolicy.from_config(config_to_use, obs_space, action_space)
